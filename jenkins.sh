...
if [[ "v2" == "${BRANCH_NAME}" ]]; then
	...
	ssh apt.enlightns.ca "sudo cp /srv/apps/production/www.jdlabs.co/www.jdlabs.co.conf /etc/nginx/sites-available/www.jdlabs.co.conf; sudo systemctl reload nginx.service"
else
