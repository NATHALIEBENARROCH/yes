...
if [[ "develop" == "${BRANCH_NAME}" ]]; then
	...
	/usr/bin/rsync -azvh fr/public srv1.enlightns.com:/srv/apps/staging/beta.jdlabs.co/fr
	/usr/bin/rsync -azvh beta.jdlabs.co.conf srv1.enlightns.com:/srv/apps/staging/beta.jdlabs.co/
	ssh srv1.enlightns.com "sudo cp /srv/apps/staging/beta.jdlabs.co/beta.jdlabs.co.conf /etc/nginx/sites-available/beta.jdlabs.co.conf; sudo systemctl reload nginx.service"
	...
	/usr/bin/rsync -azvh www.jdlabs.co.conf index.php deploy.sh srv1.enlightns.com:/srv/apps/production/www.jdlabs.co/
	ssh srv1.enlightns.com "bash /srv/apps/production/www.jdlabs.co/deploy.sh"
else
